% same_loci_double_homozygotes_odeplot_(100,0.4,0.1,1,1);
% same_loci_double_homozygotes_plot(100,0.4,0.1,1,1);

function [generation_list,cifa_allele,cifb_allele,cifa_carrier,cifb_carrier] = same_loci_double_homozygotes_odeplot_(generations,Ia,Ib,F,drawplot)
    F = sqrt(F);
    format long;
    y0 = [1-Ia-Ib;0;0;Ia;Ib;0];
    %ww,wa,wb,aa,bb,ab
