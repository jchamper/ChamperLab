...
if exist(['tempdata' name '.mat'],'file') == 0
    ...
    intro_y = linspace(0.15,0.4,num_points);
    y_min = intro_y(1);
    ...
    for intro = intro_y
        intro
        for f = fitness_x
            [gen,a_al,b_al,a_ca,b_ca] = same_loci_double_homozygotes_odeplot([0,GENERATIONS],intro,intro,f,0);
...
heatmap_plotter('08 average cifA allele',fitness_x,intro_y,average_a_al,'CifA homozygote fitness','Introduction frequency',5,2,6,2,[0,1],false);
heatmap_plotter('08 average cifB allele',fitness_x,intro_y,average_b_al,'CifA homozygote fitness','Introduction frequency',5,2,6,2,[0,1],false);
heatmap_plotter('08 average cifA carrier',fitness_x,intro_y,average_a_ca,'CifA homozygote fitness','Introduction frequency',5,2,6,2,[0,1],false);
heatmap_plotter('08 average cifB carrier',fitness_x,intro_y,average_b_ca,'CifA homozygote fitness','Introduction frequency',5,2,6,2,[0,1],false);
heatmap_plotter('08 max cifA allele frequency', fitness_x,intro_y,max_alfreq,'CifA homozygote fitness','Introduction frequency',5,2,6,2,[0.3,1],false,2,'w');
heatmap_plotter('08 max cifA allele generation', fitness_x,intro_y,max_algen,'CifA homozygote fitness','Introduction frequency',5,2,6,2,[0,300],false,3);
heatmap_plotter('08 max cifA carrier frequency', fitness_x,intro_y,max_cafreq,'CifA homozygote fitness','Introduction frequency',5,2,6,2,[0.3,1],false,2,'w');
heatmap_plotter('08 max cifA carrier generation', fitness_x,intro_y,max_cagen,'CifA homozygote fitness','Introduction frequency',5,2,6,2,[0,300],false,3);
heatmap_plotter('08 cifA protection time', fitness_x,intro_y,protection_time,'CifA homozygote fitness','Introduction frequency',5,2,6,2,[0,300],false,1,0);
