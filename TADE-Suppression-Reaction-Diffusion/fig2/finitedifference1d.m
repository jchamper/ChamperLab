...
t=50;
hold on
H2b=plot(x,X1(t/dt,:)+X2(t/dt,:)+X3(t/dt,:)+X4(t/dt,:)+X5(t/dt,:)+X6(t/dt,:),'LineWidth',1)
...
saveas(H2b,'fig_2b.jpg')

q=(X2/2+X3/2+X4+X5+X6)./(X1+X2+X3+X4+X5+X6);
figure
hold on
H2a=plot(x,q(1,:),'LineWidth',1.5)
